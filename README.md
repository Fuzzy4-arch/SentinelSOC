...
### SentinelSOC Detection Output

![SentinelSOC Terminal Output](terminal-output.png)

The monitoring engine successfully processes security events and generates alerts for suspicious activity.

### FastAPI Documentation

![SentinelSOC API Documentation](api-docs.png)
